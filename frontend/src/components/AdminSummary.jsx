  ...
  return (
    <div className='p-6'>
      ...
      <div className='mt-12'>
        ...
        <SummaryCard icon={<FaCheckCircle/>} text="Total Approved" number={2} color = 'bg-green-600'/>
        <SummaryCard icon={<FaHourglassHalf/>} text="Total Pending" number={4} color = 'bg-yellow-600'/>
        <SummaryCard icon={<FaTimesCircle/>} text="Total Rejected" number={1} color = 'bg-red-600'/>
        </div>
      </div>
    </div>
  )
